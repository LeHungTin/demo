<?php include 'header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php 
      $user = mysqli_query($conn,"SELECT * FROM users WHERE group_name = 'admin'");
            ...
            <?php foreach($user as $u) { ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="admin-delete.php?id=<?php echo $u['id']; ?>" class="btn btn-xs btn-danger" onclick="return confirm('bạn có chắc không')">Xóa</a>
                </td>
              </tr>
            <?php } ?>
            </tbody>
